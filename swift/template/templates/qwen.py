    ...
    def _encode(self, inputs: StdTemplateInputs) -> Dict[str, Any]:
        ...
        for media_type in ['image', 'video']:
            ...
            if idx_list:
                ...
                if media_grid_thw is None:
                    # No actual media data for these tokens (e.g. vLLM-generated response
                    # containing stray media pad tokens). Skip extension to avoid crash.
                    continue
